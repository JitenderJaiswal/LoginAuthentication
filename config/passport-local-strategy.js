...
//passReqToCallback:true(connect to flash error messages)
...
passport.checkAuthentication=function(req,res,next){
    //if the user is digned in,then pass on the next function(controller's action)
...
passport.setAuthenticatedUser=function(req,res,next){
   ...
   next();//when server is restart then session data is lost and and we automatically signout then we use mongostore
          //fix sign-in and sign-out is visible when user is already log-in
}
